/**
 * It is hard to tell if using es6/fetch is a good or bad choice, it could mean that the programmer is aware of es6 but it could also mean that the programmer is not thinking about older browser.
 */
